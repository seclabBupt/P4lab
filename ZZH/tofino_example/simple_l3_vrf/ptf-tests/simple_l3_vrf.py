...
"""
PTF foundational class for simple_l3_vrf.p4

This module contains the P4ProgramTest class specifically taylored for 
simple_l3_vrf program (eventually this tayloring will go away).
...
class BaseProgramTest(BfRuntimeTest):
    ...
    def setUp(self):
        ...
        # Create table shortcuts and annotations
        ...
        #self.ipv4_host.info.data_field_annotation_add(
        ...
        #self.ipv4_lpm.info.data_field_annotation_add(
        #    "new_mac_da", "Ingress.l3_switch", "mac")
        #self.ipv4_lpm.info.data_field_annotation_add(
        #    "new_mac_sa", "Ingress.l3_switch", "mac")
