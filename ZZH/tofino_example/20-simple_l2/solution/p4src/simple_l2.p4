...
#if defined(EGRESS_SINGLE_TABLE)
#include "egress_single_table.p4"
#elif defined (EGRESS_TABLE_AND_IF)
#include "egress_table_and_if.p4"
#elif defined (EGRESS_TABLE_AND_SWITCH)
#include "egress_table_and_switch.p4"
#elif defined (EGRESS_TABLE_AND_TABLE)
#include "egress_table_and_table.p4"
#elif defined (EGRESS_REGISTERS_AND_IF)
#include "egress_registers_and_if.p4"
#elif defined (EGRESS_REGISTERS_AND_TABLE)
#include "egress_registers_and_table.p4"
#else
#include "egress_single_table.p4"  /* That's the default */
#endif
